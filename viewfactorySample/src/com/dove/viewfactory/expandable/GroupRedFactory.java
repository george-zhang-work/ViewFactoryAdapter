...
public class GroupRedFactory implements ViewGroupFactory, View.OnClickListener {
    ...
    public static class ViewInfo {
        Pair<GroupTextInfo, ColorDarkInfo> zero = MenuInfo.GROUP_RED;

        Pair<ChildTextInfo, ColorLightInfo> three = MenuInfo.CHILD_GREEN;
        int cone = MenuInfo.GREEN_COUNT;
        Pair<ChildTextInfo, ColorLightInfo> two = MenuInfo.CHILD_BLUE;
        int ctwo = MenuInfo.BLUE_COUN;
        Pair<ChildTextInfo, ColorLightInfo> one = MenuInfo.CHILD_ORANGE;
