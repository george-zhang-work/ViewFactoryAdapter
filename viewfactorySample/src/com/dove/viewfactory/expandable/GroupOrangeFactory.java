...
public class GroupOrangeFactory implements ViewGroupFactory, View.OnClickListener {
    ...
    public static class ViewInfo {
        Pair<GroupTextInfo, ColorDarkInfo> zero = MenuInfo.GROUP_ORANGE;

        Pair<ChildTextInfo, ColorLightInfo> one = MenuInfo.CHILD_GREEN;
        int cone = MenuInfo.GREEN_COUNT;
        Pair<ChildTextInfo, ColorLightInfo> four = MenuInfo.CHILD_BLUE;
        int ctwo = MenuInfo.BLUE_COUN;
        Pair<ChildTextInfo, ColorLightInfo> three = MenuInfo.CHILD_ORANGE;
        int cthree = MenuInfo.ORANGE_COUNT;
        Pair<ChildTextInfo, ColorLightInfo> two = MenuInfo.CHILD_RED;
